...
object TestmutipleRecords extends App{
  ...
  dbstore.put(new TestObject("1","abc","1"),tx)
  dbstore.put(new TestObject("2","abc","1"),tx)
  dbstore.put(new TestObject("3","abc","0"),tx)
  dbstore.put(new TestObject("4","abc","0"),tx)
  dbstore.put(new TestObject("5","def","0"),tx)
  dbstore.put(new TestObject("6","fff","0"),tx)
  dbstore.put(new TestObject("7","fff","0"),tx)
  tx.commit()
